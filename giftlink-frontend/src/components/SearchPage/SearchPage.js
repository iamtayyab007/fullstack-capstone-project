...
function SearchPage() {
    ...
    const [ageRange, setAgeRange] = useState(6); // default minimum age
    ...
    // Task 2: Handle search based on filters
                            ...
                            searchResults.map(product => (
                                <div key={product.id} className="card mb-3">
                                    {product.image ? (
                                        ...
                                        <div className="text-center p-3 bg-light">No Image Available</div>
                                    )}
